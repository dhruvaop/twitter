...
consumerKey = "E8iDb0aqaB00DsQormZFli80m"
consumerSecret = "N91QTJfPEtZgmLtsE6mZPTKPOoWCc3GYqCoc7D4uSddC4s7uPs"
accessToken = "1415789702821654528-YL0oCDTRpTS2WD9R4Erw9DQ3ZTMyoT"
accessTokenSecret = "ET24644xgTccS825G5woFaK1ujnHnKOm92Igrb0PAazNl"
...
def app():
	...
	st.title("Tweet Analyzer 🔥 Welcome to Streamlit! 👋 #Learnwithdhruva 😇👨‍💻")
	...
	if choice=="Tweet Analyzer":
		...
		st.write("1. Fetches the 5 most recent tweets from the given twitter handel that have posted recently")
		...
		raw_text = st.text_area("Enter the exact twitter handle of the Personality (without @) for example:- DhruvaBhattach2")
		...
		user_name = st.text_area("Enter the exact twitter handle of the Personality (without @) for example:- DhruvaBhattach2")
	...
	st.subheader(' Created By :  DHRUVA BHATTACHARYA :sunglasses:')
